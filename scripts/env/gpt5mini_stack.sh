# The gpt-5-mini optimization stack. Source this before launching a run:
...
FRESH_PROMPT_DELTA_GENERATOR_MODEL_ID=gpt-5-mini
...
SR_PROMPT_GENERATOR_MODEL_ID=gpt-5-mini
SR_GENERATOR_REASONING_EFFORT=minimal
...
FRESH_PROMPT_DELTA_GENERATOR_MAX_OUTPUT_TOKENS=4096

FRESH_PROMPT_DELTA_OPTIMIZER_MODEL_ID=gpt-5-mini
SR_FEEDBACK_REASONING_EFFORT=medium
SR_UPDATER_REASONING_EFFORT=high
FRESH_PROMPT_DELTA_OPTIMIZER_MAX_OUTPUT_TOKENS=32000

# The minimal feedback payload and the structural tool-evidence compaction.
SR_EPISODE_FEEDBACK_VIEW=1
SR_COMPACT_TOOL_EVIDENCE=1
